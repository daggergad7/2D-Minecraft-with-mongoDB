...
public class Map {
  ...
  public ArrayList<MappedTile> getTileArray() {
    return mappedTiles;
  }
  ...
  public void saveMap() {
    try {
      ...
      PrintWriter printWriter = new PrintWriter("./src/Map.txt");
  ...
  public void render(RenderHandler renderer, ObjectLoader[] objects, int xZoom, int yZoom) {
    int tileWidth = 16 * xZoom;
    int tileHeight = 16 * yZoom;
